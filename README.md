...
Key Features
•	Hybrid CNN / ViT-stem + Variational Quantum Circuit (VQC) architecture
...
o	Embedding separability
o	Robustness to noise and domain shift
o	Calibration reliability
...
data/LIDC-IDRI/{train,val,test}/{CASE_ID}/
  ├── ct.nii.gz
  └── mask.nii.gz
Note: Dataset preparation scripts are not included. Users must ensure datasets are preprocessed and split consistently with experimental protocols.
